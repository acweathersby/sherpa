...
impl JSParserConfig {
  ...
  #[wasm_bindgen(getter = ALLOW_LOOKAHEAD_MERGE)]
  pub fn ALLOW_LOOKAHEAD_MERGE(self) -> bool {
    self._config.ALLOW_LOOKAHEAD_MERGE
  }

  #[wasm_bindgen(setter = ALLOW_LOOKAHEAD_MERGE)]
  pub fn set_ALLOW_LOOKAHEAD_MERGE(&mut self, val: bool) {
    self._config.ALLOW_LOOKAHEAD_MERGE = val;
  }
