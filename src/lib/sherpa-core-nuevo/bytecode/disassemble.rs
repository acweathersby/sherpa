...
use sherpa_runtime::types::{
  bytecode::{InputType, Instruction, FIRST_PARSE_BLOCK_ADDRESS},
  TableHeaderData,
};
...
pub fn disassemble_parse_block<'a>(
  ...
  if !i.is_valid() {
    ...
    use sherpa_runtime::types::bytecode::Opcode::*;
    match i.get_opcode() {
...
pub fn generate_disassembly(bc: &[u8], db: Option<&ParserDatabase>) -> String {
