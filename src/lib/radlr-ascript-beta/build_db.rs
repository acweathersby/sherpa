...
pub fn process_struct(adb: &mut AscriptDatabase, strct: &AST_Struct, g_id: GrammarIdentities) -> RadlrResult<StructInitializer> {
...
/// Struct.
fn get_resolved_type(a: AscriptType, b: AscriptType) -> RadlrResult<AscriptType> {
