...
/// relating a symbol to a particular production body.
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct BodySymbol {
  pub sym_id: SymbolID,

  /// The 0 index position of this symbol within the original body
...
pub struct Body {
  pub syms: Vec<BodySymbol>,
  pub len: u16,
  pub prod_id: ProductionId,
  pub id: BodyId,
  pub bc_id: u32,
  pub reduce_fn_ids: Vec<ReduceFunctionId>,
  /// A token that covers the definition of this body.
  pub tok: Token,
  /// A reference to the identifiers of the owning grammar.
  pub grammar_ref: Arc<GrammarIds>,
}
