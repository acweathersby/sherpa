...
impl ErrPropRedefinition {
  ...
  pub fn new(
    ...
    SherpaError::ExtendedError(Arc::new(Self { struct_type, prop_name, existing_prop, new_prop }))
  }
}
...
impl ErrUnionOfScalarsAndVectors {
  ...
  pub fn new(
    ...
    SherpaError::ExtendedError(Arc::new(Self {
      scalars,
      vectors,
      p: prod_id,
      g: grammar,
...
impl ErrIncompatibleProductionScalerTypes {
  ...
  pub fn new(
    ...
    SherpaError::ExtendedError(Arc::new(Self { p, g, type_a, type_b, type_names }))
  }
}
...
impl ErrIncompatibleProductionVectorTypes {
  ...
  pub fn new(
    ...
    SherpaError::ExtendedError(Arc::new(Self { p, g, vector_types, type_names }))
  }
}
