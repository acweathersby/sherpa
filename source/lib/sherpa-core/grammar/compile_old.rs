...
use crate::{
  grammar::{data::ast::Ascript, load::load_all, parse::compile_ascript_ast},
...
fn finalize_bytecode_metadata(g: &mut GrammarStore, _: &mut [SherpaError]) {
...
/// to right recursive.
fn finalize_productions(g: &mut GrammarStore, _: &mut [SherpaError]) {
