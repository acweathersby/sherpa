...
impl<const STACK_SIZE: usize, T> Default for StackVec<STACK_SIZE, T> {
  fn default() -> Self {
    Self::new()
  }
}
...
impl<const STACK_SIZE: usize, T: Debug> FromIterator<T> for StackVec<STACK_SIZE, T> {
...
impl<const STACK_SIZE: usize, T, I: Iterator<Item = T>> From<I> for StackVec<STACK_SIZE, T> {
