...
use super::{ByteReader, MutByteReader, ParseContext, RadlrParser, UTF8Reader};
...
impl<'a, R: ByteReader + MutByteReader + UTF8Reader, M, ByteCode: AsRef<[u8]>> RadlrParser<R, M, true>
