...
#[no_mangle]
pub extern "C" fn radlr_free_stack(ptr: *mut Goto, byte_size: usize) {
...
#[no_mangle]
pub extern "C" fn radlr_get_token_class_from_codepoint(codepoint: u32) -> u32 {
  get_token_class_from_codepoint(codepoint)
}

#[no_mangle]
pub extern "C" fn radlr_allocate_stack(byte_size: usize) -> *mut Goto {
  // Each goto slot is 16bytes, so we shift left num_of_slots by 4 to get the
  // bytes size of the stack.
